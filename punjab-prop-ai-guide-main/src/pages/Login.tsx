...
const Login = () => {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-72 h-72 bg-[hsl(var(--gold)/0.08)] rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-[hsl(var(--primary)/0.15)] rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      ...
      <div className="relative z-10 w-full max-w-md px-4 animate-fade-in">
        ...
        <div className="relative rounded-2xl border border-white/10 bg-white/[0.07] backdrop-blur-xl shadow-2xl shadow-black/20 p-8">
          ...
          <h2 className="font-display text-2xl font-bold text-white text-center mb-1">Welcome Back</h2>
          <p className="text-white/50 text-sm text-center mb-6">Sign in to access property predictions</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative group">
                <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-white/30 group-focus-within:text-[hsl(var(--gold))] transition-colors" />
                <input
                  type="email"
                  required
                  value={form.email}
                  ...
                  className="w-full pl-11 pr-4 py-3 rounded-xl border border-white/10 bg-white/[0.05] text-white text-sm placeholder:text-white/25 focus:outline-none focus:ring-2 focus:ring-[hsl(var(--gold)/0.5)] focus:border-[hsl(var(--gold)/0.3)] focus:bg-white/[0.08] transition-all duration-300"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative group">
                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-white/30 group-focus-within:text-[hsl(var(--gold))] transition-colors" />
                <input
